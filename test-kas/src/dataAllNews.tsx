...
//создал для того чтобы сделать поле дубликаты

export const dataAllNews: IData_SnippetNews[] = [
  {
    ID: 260855433,
    ...
    DP: "2022-04-06T21:00:00",
    DOM: "globalsecuritymag.com",
    SENT: "negative",
    LANG: "en",
    AU: [],
    FAV: "../public/free-icon-france-206657.png",
    //добавил повторок для того чтобы было видно show all +...
    KW: [
      {
        value: "antivirus",
